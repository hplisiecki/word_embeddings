...
def issue_ownership(model, topic_vector=None, topic_word=None, infer_vector=True, t_size = 20, boot=True, smooth=True):
...
def fit(model, topic_vector, smooth=True, boot=True):
